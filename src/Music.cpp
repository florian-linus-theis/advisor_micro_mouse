...
int length8 [] {V, V, A, A, V, V};
int pause8 []  {L, L, M, M, L, L};
...
int* full_90s_pause[] = {
 ...
 int full_90s_counts[] = {
    sizeof(beat0) / sizeof(beat0[0]), 
    sizeof(beat1) / sizeof(beat1[0]), 
    sizeof(beat0) / sizeof(beat0[0]), 
    sizeof(beat1) / sizeof(beat1[0]),   
    sizeof(beat2) / sizeof(beat2[0]),
    sizeof(beat3) / sizeof(beat3[0]),
    sizeof(beat2) / sizeof(beat2[0]),
    sizeof(beat4) / sizeof(beat4[0]),
    sizeof(beat2) / sizeof(beat2[0]),
    sizeof(beat3) / sizeof(beat3[0]),
    sizeof(beat2) / sizeof(beat2[0]),
    sizeof(beat1) / sizeof(beat1[0]),
    sizeof(beat5) / sizeof(beat5[0]),
    sizeof(beat3) / sizeof(beat3[0]),
    sizeof(beat5) / sizeof(beat5[0]),
    sizeof(beat6) / sizeof(beat6[0]),
    sizeof(beat5) / sizeof(beat5[0]),
    sizeof(beat3) / sizeof(beat3[0]),
    sizeof(beat5) / sizeof(beat5[0]),
    sizeof(beat1) / sizeof(beat1[0]),
    sizeof(beat7) / sizeof(beat7[0]),
    sizeof(beat9) / sizeof(beat9[0]),
    sizeof(beat15) / sizeof(beat15[0]),
    sizeof(beat10) / sizeof(beat10[0]),
    sizeof(beat15) / sizeof(beat15[0]),
    sizeof(beat11) / sizeof(beat11[0]),
    sizeof(beat9) / sizeof(beat9[0]),
    sizeof(beat12) / sizeof(beat12[0]),
    sizeof(beat11) / sizeof(beat11[0]),
    sizeof(beat9) / sizeof(beat9[0]),
    sizeof(beat10) / sizeof(beat10[0]),
    sizeof(beat11) / sizeof(beat11[0]),
    sizeof(beat9) / sizeof(beat9[0]),
    sizeof(beat16) / sizeof(beat16[0]),
    sizeof(beat13) / sizeof(beat13[0]),
    sizeof(beat17) / sizeof(beat17[0]),
    sizeof(beat14) / sizeof(beat14[0])
};
...
for(int i = 0; i < sizeof(beat0) / sizeof(beat0[0]); i++){
        ble->println("b_cnt: 0 n_cnt: " + String(i));
        ble->println("note: " + String(full_90s_notes[0][i]) + " length: " + String(full_90s_length[0][i]) + "  pause: " + String(full_90s_pause[0][i]+full_90s_length[0][i]));
        ble->println("note: " + String(beat0[i]) + " length: " + String(length0[i]) + "  pause: " + String(length0[i]+pause0[i]));
...
void Timer13_Interrupt() {
        ...
        //ble->println("note: " + String(full_90s_notes[beat_cnt][note_cnt]) + " length: " + String(full_90s_length[beat_cnt][note_cnt]) + "  pause: " + String(full_90s_pause[beat_cnt][note_cnt]+full_90s_length[beat_cnt][note_cnt]));

        note_cnt++;

        if (note_cnt >= full_90s_counts[beat_cnt]) {
                note_cnt = 0;
                beat_cnt++;
        }
        if (beat_cnt > 36) {
